...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section class="content" style="height: 900px;overflow-y: scroll;">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2017 <a href="#">湖北石油高管分公司</a>.</strong> All rights reserved.
    </footer>
